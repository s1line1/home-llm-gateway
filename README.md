...
| 方案 | QPS | p50 | CPU/请求 | 线程数 |
|---|---|---|---|---|
| 现状：每请求 `spawn_blocking` 落库 | 1 573 | 93ms | 10.9ms | **521** |
| 跳过落库（仅实验） | **16 097** | 12.0ms | 2.83ms | 94 |
| 批量落库（按 key 累积 + 500ms 单事务 flush，仅实验） | **20 491** | 9.1ms | 2.56ms | 147 |
